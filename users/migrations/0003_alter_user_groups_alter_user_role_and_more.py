# Generated by Django 5.0.1 on 2026-01-29 12:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='role',
            field=models.CharField(blank=True, choices=[('owner', 'Owner'), ('accountant', 'Accountant'), ('analyst', 'Analyst')], db_index=True, default='owner', help_text='User role for permissions (owner/accountant/analyst)', max_length=20, null=True),
        ),
        migrations.AlterField(
            model_name='user',
